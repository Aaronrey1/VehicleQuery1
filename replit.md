...
- **Date: November 18, 2025**
  - Added comprehensive API documentation page at `/api-docs` with request/response examples for all 5 public endpoints (AI Search, VIN Decoder, Vehicle Search, Bulk Search, Geometris)
  ...
  - Documentation includes copyable code blocks, error responses, rate limits, and best practices for Salesforce integration